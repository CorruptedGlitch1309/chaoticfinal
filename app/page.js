...
export default function page() {
  ...
  const getSelectedParams = () =>
    JSON.parse(
      searchParams.get("selected") ? searchParams.get("selected") : "[[]]"
    );
  const getLoadoutParams = () =>
    JSON.parse(
      searchParams.get("loadouts") ? searchParams.get("loadouts") : "[]"
    );
  const getRandomizerParams = () =>
    searchParams.get("randomizerType")
      ? searchParams.get("randomizerType")
      : "team-randomizer";
